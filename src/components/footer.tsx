      ...
      <div className="container px-4 md:px-6 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
          <div className="space-y-4">
            <h3 className="text-lg font-semibold">Shreyas Kashyap</h3>
            <p className="text-sm text-muted-foreground max-w-xs">
              Aspiring Data Analyst and ML Engineer focused on turning complex data into
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <a 
                href="https://github.com/ShreyasKashyap357"
                target="_blank"
              ...
              {/* Removed <ThemeToggle /> here as requested */}
            </div>
          </div>
        </div>
        
        <div className="border-t border-border/40 mt-8 pt-6 flex flex-col md:flex-row items-center justify-between">
          <p className="text-sm text-muted-foreground">
            &copy; {currentYear} Shreyas Kashyap. All rights reserved.
          </p>
